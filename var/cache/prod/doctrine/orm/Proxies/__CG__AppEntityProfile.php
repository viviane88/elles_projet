...
class Profile extends \App\Entity\Profile implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Profile' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Profile' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Profile' . "\0" . 'firstname', '' . "\0" . 'App\\Entity\\Profile' . "\0" . 'address', '' . "\0" . 'App\\Entity\\Profile' . "\0" . 'job', '' . "\0" . 'App\\Entity\\Profile' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Profile' . "\0" . 'user'];
        }
     ...
     * {@inheritDoc}
     */
    public function setJob(?string $job): \App\Entity\Profile
    {
     ...
     * {@inheritDoc}
     */
    public function setDescription(?string $description): \App\Entity\Profile
    {
