...
$catalogue = new MessageCatalogue('ru', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'Длина пароля должна быть не менее {{length}} символов.',
    'Your password must include at least one letter.' => 'Пароль должен содержать, по крайней мере, одну букву.',
    'Your password must include both upper and lower case letters.' => 'Пароль должен содержать как прописные, так и строчные буквы.',
    'Your password must include at least one number.' => 'Пароль должен содержать, по крайней мере, одну цифру.',
    'Your password must contain at least one special character.' => 'Пароль должен содержать, по крайней мере, один специальный символ.',
    'password_too_weak' => 'Пароль должен быть как минимум "{{ min_strength }}" уровня сложности, текущий уровень сложности "{{ current_strength }}", обратите внимание на эти советы: {{ strength_tips }}.',
    'rollerworks_password.strength_level.very_weak' => 'Очень слабый',
    'rollerworks_password.strength_level.weak' => 'Слабый',
    'rollerworks_password.strength_level.medium' => 'Средний',
    'rollerworks_password.strength_level.strong' => 'Сильный',
    'rollerworks_password.strength_level.very_strong' => 'Очень сильный',
    'rollerworks_password.tip.letters' => 'добавить буквы (прописные / строчные)',
    'rollerworks_password.tip.numbers' => 'добавить цифры',
    'rollerworks_password.tip.lowercase_letters' => 'добавить строчные буквы',
    'rollerworks_password.tip.uppercase_letters' => 'добавить заглавные буквы',
    'rollerworks_password.tip.special_chars' => 'добавить специальные символы',
    'rollerworks_password.tip.length' => 'добавить больше символов',
  ),
  'security' => 
  array (
