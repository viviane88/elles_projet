...
$catalogue = new MessageCatalogue('it', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'La password deve contenere almeno {{length}} caratteri.',
    'Your password must include at least one letter.' => 'La password deve contenere almeno una lettera.',
    'Your password must include both upper and lower case letters.' => 'La password deve contenere almeno delle maiuscole e delle minuscole.',
    'Your password must include at least one number.' => 'La password deve contenere almeno una cifra.',
    'Your password must contain at least one special character.' => 'La password deve contenere almeno un carattere speciale.',
    'password_too_weak' => 'La password deve avere una forza di almeno {{ min_strength }}"; la forza attuale è "{{ current_strength }}"; provare quanto segue: {{ strength_tips }}.',
    'rollerworks_password.strength_level.very_weak' => 'Molto debole',
    'rollerworks_password.strength_level.weak' => 'Debole',
    'rollerworks_password.strength_level.medium' => 'Media',
    'rollerworks_password.strength_level.strong' => 'Forte',
    'rollerworks_password.strength_level.very_strong' => 'Molto forte',
    'rollerworks_password.tip.letters' => 'aggiungi delle lettere (maiuscole/minuscole)',
    'rollerworks_password.tip.numbers' => 'aggiungi delle cifre',
    'rollerworks_password.tip.lowercase_letters' => 'aggiungi delle minuscole',
    'rollerworks_password.tip.uppercase_letters' => 'aggiungi delle maiuscole',
    'rollerworks_password.tip.special_chars' => 'aggiungi dei caratteri speciali',
    'rollerworks_password.tip.length' => 'aggiungi più caratteri',
  ),
  'security' => 
  array (
