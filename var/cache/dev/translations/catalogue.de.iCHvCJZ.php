...
$catalogue = new MessageCatalogue('de', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'Das Passwort muss aus mindestens {{length}} Zeichen bestehen.',
    'Your password must include at least one letter.' => 'Das Passwort muss mindestens einen Buchstaben enthalten.',
    'Your password must include both upper and lower case letters.' => 'Das Passwort muss Groß- und Kleinbuchstaben enthalten.',
    'Your password must include at least one number.' => 'Das Passwort muss mindestens eine Ziffer enthalten.',
    'Your password must contain at least one special character.' => 'Das Passwort muss mindestens ein Sonderzeichen enthalten.',
    'password_too_weak' => 'Die Passwortstärke muss mindestens "{{ min_strength }}" sein, die aktuelle Stärke ist "{{ current_strength }}". Versuchen Sie Folgendes: {{ strength_tips }}.',
    'rollerworks_password.strength_level.very_weak' => 'Sehr schwach',
    'rollerworks_password.strength_level.weak' => 'Schwach',
    'rollerworks_password.strength_level.medium' => 'Mittel',
    'rollerworks_password.strength_level.strong' => 'Stark',
    'rollerworks_password.strength_level.very_strong' => 'Sehr stark',
    'rollerworks_password.tip.letters' => 'Buchstaben hinzufügen (Großbuchstaben/Kleinbuchstaben)',
    'rollerworks_password.tip.numbers' => 'Ziffern hinzufügen',
    'rollerworks_password.tip.lowercase_letters' => 'Kleinbuchstaben hinzufügen',
    'rollerworks_password.tip.uppercase_letters' => 'Großbuchstaben hinzufügen',
    'rollerworks_password.tip.special_chars' => 'Sonderzeichen hinzufügen',
    'rollerworks_password.tip.length' => 'Weitere Zeichen hinzufügen',
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'Das Passwort steht in einem Datenbank mit durchgesickerten Passwörtern. Es wurde {{ used }} Mal genutzt. Aus Sicherheitsgründen müssen Sie ein anderes Passwort wählen.',
  ),
  'security' => 
  array (
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'Password must be at least {{length}} characters long.',
    'Your password must include at least one letter.' => 'Password must include at least one letter.',
    'Your password must include both upper and lower case letters.' => 'Password must include both upper and lower case letters.',
    'Your password must include at least one number.' => 'Password must include at least one number.',
    'Your password must contain at least one special character.' => 'Password must contain at least one special character.',
    'password_too_weak' => 'Password needs to be at least at strength level "{{ min_strength }}", current level is "{{ current_strength }}", try the following: {{ strength_tips }}.',
    'rollerworks_password.strength_level.very_weak' => 'Very Weak',
    'rollerworks_password.strength_level.weak' => 'Weak',
    'rollerworks_password.strength_level.medium' => 'Medium',
    'rollerworks_password.strength_level.strong' => 'Strong',
    'rollerworks_password.strength_level.very_strong' => 'Very strong',
    'rollerworks_password.tip.letters' => 'add (upper/lowercase) letters',
    'rollerworks_password.tip.numbers' => 'add numbers',
    'rollerworks_password.tip.lowercase_letters' => 'add lowercase letters',
    'rollerworks_password.tip.uppercase_letters' => 'add uppercase letters',
    'rollerworks_password.tip.special_chars' => 'add special characters',
    'rollerworks_password.tip.length' => 'add more characters',
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.',
  ),
  'security' => 
  array (
