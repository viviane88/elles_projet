...
$catalogue = new MessageCatalogue('ja', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'パスワードは最低でも {{length}} 文字必要です。',
    'Your password must include at least one letter.' => 'パスワードは最低でも1文字必要です。',
    'Your password must include both upper and lower case letters.' => 'パスワードには大文字と小文字を含む必要があります。',
    'Your password must include at least one number.' => 'パスワードには最低でも数字がひとつ必要です。',
    'Your password must contain at least one special character.' => 'パスワードは最低でも一つの特殊記号が必要です。',
    'password_too_weak' => 'パスワードは最低でも強度"{{ min_strength }}"レベル以上が必要です。現在のレベルは"{{ current_strength }}"なので、こちらをお試しください。 {{ strength_tips }}',
    'rollerworks_password.strength_level.very_weak' => 'とても弱い',
    'rollerworks_password.strength_level.weak' => '弱',
    'rollerworks_password.strength_level.medium' => '中',
    'rollerworks_password.strength_level.strong' => '強',
    'rollerworks_password.strength_level.very_strong' => 'とても強い',
    'rollerworks_password.tip.letters' => '（大文字/小文字)を追加してください',
    'rollerworks_password.tip.numbers' => '数字を追加してください。',
    'rollerworks_password.tip.lowercase_letters' => '小文字を追加してください',
    'rollerworks_password.tip.uppercase_letters' => '大文字を追加してください',
    'rollerworks_password.tip.special_chars' => '特殊記号を追加してください',
    'rollerworks_password.tip.length' => '文字数が足りてません。追加してください',
  ),
  'security' => 
  array (
