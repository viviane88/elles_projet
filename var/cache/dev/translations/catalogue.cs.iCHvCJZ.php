...
$catalogue = new MessageCatalogue('cs', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'Heslo musí mít alespoň {{length}} znaků.',
    'Your password must include at least one letter.' => 'Heslo musí obsahovat písmeno.',
    'Your password must include both upper and lower case letters.' => 'Heslo musí obsahovat velká i malá písmena.',
    'Your password must include at least one number.' => 'Heslo musí obsahovat číslici.',
    'Your password must contain at least one special character.' => 'Heslo musí obsahovat speciální znak.',
    'password_too_weak' => 'Úroveň hesla musí být alespoň "{{ min_strength }}", současná úroveň je "{{ current_strength }}", zkuste {{ strength_tips }}.',
    'rollerworks_password.strength_level.very_weak' => 'velmi slabé',
    'rollerworks_password.strength_level.weak' => 'slabé',
    'rollerworks_password.strength_level.medium' => 'střední',
    'rollerworks_password.strength_level.strong' => 'silné',
    'rollerworks_password.strength_level.very_strong' => 'velmi silné',
    'rollerworks_password.tip.letters' => 'přidat malá/velká písmena',
    'rollerworks_password.tip.numbers' => 'přidat číslici',
    'rollerworks_password.tip.lowercase_letters' => 'přidat malé písmeno',
    'rollerworks_password.tip.uppercase_letters' => 'přidat velké písmeno',
    'rollerworks_password.tip.special_chars' => 'přidat speciální znak',
    'rollerworks_password.tip.length' => 'delší heslo',
  ),
  'security' => 
  array (
