...
$catalogue = new MessageCatalogue('nl', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'Wachtwoord moet minstens {{length}} tekens lang zijn.',
    'Your password must include at least one letter.' => 'Wachtwoord moet ten minste één letter bevatten.',
    'Your password must include both upper and lower case letters.' => 'Wachtwoord moet ten minste één hoofdletter en kleine letter bevatten.',
    'Your password must include at least one number.' => 'Wachtwoord moet ten minste één nummer bevatten.',
    'Your password must contain at least one special character.' => 'Wachtwoord moet ten minste één speciaal teken of leesteken bevatten.',
    'password_too_weak' => 'Wachtwoord moet minstens aan sterkte niveau "{{ min_strength }}" voldoen, huidig niveau is “{{ current_strength }}” probeer het volgende: {{ strength_tips }}.',
    'rollerworks_password.strength_level.very_weak' => 'Erg zwak',
    'rollerworks_password.strength_level.weak' => 'Zwak',
    'rollerworks_password.strength_level.medium' => 'Gemiddeld',
    'rollerworks_password.strength_level.strong' => 'Sterk',
    'rollerworks_password.strength_level.very_strong' => 'Zeer sterk',
    'rollerworks_password.tip.letters' => 'voeg (hoofd/kleine) letters toe',
    'rollerworks_password.tip.numbers' => 'voeg nummers toe',
    'rollerworks_password.tip.lowercase_letters' => 'voeg kleine letters toe',
    'rollerworks_password.tip.uppercase_letters' => 'voeg hoofdletters toe',
    'rollerworks_password.tip.special_chars' => 'voeg speciaal tekens of leestekens toe',
    'rollerworks_password.tip.length' => 'gebruik meer tekens',
    'This password was found in a database of compromised passwords. It has been used {{ used }} times. For security purposes you must use something else.' => 'Het wachtwoord is gevonden in een database van gelekte wachtwoorden. Het is {{ used }} keer gebruikt. Uit veiligheidsoverwegingen dient u een ander wachtwoord te kiezen.',
  ),
  'security' => 
  array (
