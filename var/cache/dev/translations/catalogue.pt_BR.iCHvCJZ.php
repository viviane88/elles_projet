...
$catalogue = new MessageCatalogue('pt_BR', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'A senha deve ter pelo menos {{length}} caracteres de comprimento.',
    'Your password must include at least one letter.' => 'A senha deve conter pelo menos uma letra.',
    'Your password must include both upper and lower case letters.' => 'A senha deve incluir letras maiúsculas e minúsculas.',
    ...
    'password_too_weak' => 'A senha deve ter pelo menos o nível de intensidade "{{ min_strength }}", o nível atual é "{{ current_strength }}", tente o seguinte: {{ strength_tips }}.',
    'rollerworks_password.strength_level.very_weak' => 'Muito fraco',
    'rollerworks_password.strength_level.weak' => 'Fraco',
    'rollerworks_password.strength_level.medium' => 'Médio',
    'rollerworks_password.strength_level.strong' => 'Forte',
    'rollerworks_password.strength_level.very_strong' => 'Muito forte',
    'rollerworks_password.tip.letters' => 'adicionar letras (maiúsculas/minúsculas)',
    'rollerworks_password.tip.numbers' => 'adicionar números',
    'rollerworks_password.tip.lowercase_letters' => 'adicionar letras minúsculas',
    'rollerworks_password.tip.uppercase_letters' => 'adicionar caracteres especiais',
    'rollerworks_password.tip.special_chars' => 'adicionar letras maiúsculas',
    'rollerworks_password.tip.length' => 'adicionar mais caracteres',
  ),
  'security' => 
  array (
