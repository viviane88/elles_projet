...
$catalogue = new MessageCatalogue('bg', array (
  ...
  array (
    ...
    'Your password must be at least {{length}} characters long.' => 'Паролата трябва да е с дължина най-малко {{length}} знака.',
    'Your password must include at least one letter.' => 'Паролата трябва да съдържа поне една буква.',
    'Your password must include both upper and lower case letters.' => 'Паролата трябва да съдържа главни и малки букви.',
    'Your password must include at least one number.' => 'Паролата трябва да съдържа поне едно число.',
    'Your password must contain at least one special character.' => 'Паролата трябва да съдържа поне един специален знак.',
    'password_too_weak' => 'Паролата трябва да е поне на ниво "{{ min_strength }}", текущото ниво е "{{ current_strength }}", опитайте това: {{ strength_tips }}.',
    'rollerworks_password.strength_level.very_weak' => 'Много слабо',
    'rollerworks_password.strength_level.weak' => 'Слабо',
    'rollerworks_password.strength_level.medium' => 'Средно',
    'rollerworks_password.strength_level.strong' => 'Силно',
    'rollerworks_password.strength_level.very_strong' => 'Много силно',
    'rollerworks_password.tip.letters' => 'добавете букви (главни/малки)',
    'rollerworks_password.tip.numbers' => 'добавете цифри',
    'rollerworks_password.tip.lowercase_letters' => 'добавете малки букви',
    'rollerworks_password.tip.uppercase_letters' => 'добавете главни букви',
    'rollerworks_password.tip.special_chars' => 'добавете специални знаци',
    'rollerworks_password.tip.length' => 'добавете още знаци',
  ),
  'security' => 
  array (
