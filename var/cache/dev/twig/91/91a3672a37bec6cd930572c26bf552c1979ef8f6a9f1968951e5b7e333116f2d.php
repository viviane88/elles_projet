...
class __TwigTemplate_2ffc3eb9fd07d3861e874cb4d6d329e8d88f9c78877df90e7e697fecd2ad0b36 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("baseAdmin.html.twig", "registration/register.html.twig", 1);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 6, $this->source); })()), "flashes", [0 => "merci de vérifier vos mails"], "method", false, false, false, 6));
...
\t\t<h1>Merci de créer votre compte</h1>
    ...
    ";
       ...
       <div class=\"\">
        ...
        ";
        // line 38
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 38, $this->source); })()), "Roles", [], "any", false, false, false, 38), 'row');
        echo "
        </div>  
...
{% block body %}
    {% for flashError in app.flashes('merci de vérifier vos mails') %}
...
{% endblock %}
", "registration/register.html.twig", "C:\\wamp64\\www\\elles\\templates\\registration\\register.html.twig");
    }
}
