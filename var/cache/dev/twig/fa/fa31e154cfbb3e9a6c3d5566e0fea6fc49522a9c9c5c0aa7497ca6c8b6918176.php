...
class __TwigTemplate_354c0425af1cc994c4aa631bc0314167742a68e8e1b97625f85b5b8b2c526d38 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<td>";
            // line 34
            echo twig_escape_filter($this->env, twig_lower_filter($this->env, twig_join_filter(twig_get_attribute($this->env, $this->source, $context["user"], "roles", [], "any", false, false, false, 34), " + ")), "html", null, true);
            echo "</td>
\t\t\t\t\t
\t\t\t\t\t<td><a href=\"";
            // line 36
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_update", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 36)]), "html", null, true);
            echo "\">
...
\t\t\t\t\t\t<a href=\"";
            // line 42
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 42)]), "html", null, true);
            echo "\">
...
";
    ...
    {
        return array (  192 => 53,  188 => 51,  165 => 42,  156 => 36,  151 => 34,  145 => 31,  141 => 30,  137 => 29,  133 => 28,  130 => 27,  113 => 26,  92 => 8,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
