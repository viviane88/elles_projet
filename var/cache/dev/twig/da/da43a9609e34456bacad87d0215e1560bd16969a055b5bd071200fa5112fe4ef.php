...
class __TwigTemplate_daa69cdb378dfc8bea1e134c7bf585d90365a0e7d0dfd8785eb0bfbab59ebe53 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("basePure.html.twig", "@Twig/Exception/error.html.twig", 1);
...
\t\t\t<img class=\"\" src=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("./image/erreur400.svg"), "html", null, true);
        echo "\" alt=\"logo\">
\t\t</div>\t
\t</div>
...
";
    ...
    {
        return new Source("{% extends \"basePure.html.twig\" %}

{% block title %}Erreur-400
{% endblock %}
...
\t\t</div>
\t\t<div class=\"col-12 text-center mt-2\">
\t\t\t<img class=\"\" src=\"{{ asset('./image/erreur400.svg') }}\" alt=\"logo\">
\t\t</div>\t
\t</div>
...
\t\t\t<p>Une erreur est survenue lors du chargement de la page. Si le problème persiste, merci de contacter
                l'administrateur du site</p>
            <a href=\"{{path('home')}}\"> <p>Retour au site</p></a>
\t</div>
...
{% endblock %}
", "@Twig/Exception/error.html.twig", "C:\\wamp64\\www\\elles\\templates\\bundles\\TwigBundle\\Exception\\error.html.twig");
    }
}
