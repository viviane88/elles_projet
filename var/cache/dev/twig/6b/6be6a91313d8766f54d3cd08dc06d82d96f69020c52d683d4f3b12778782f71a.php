...
class __TwigTemplate_64708a5e920dc92b58d2d66256cd24cd2afc821bdee13d282b52b2bea02fdd33 extends Template
{
    private $source;
    private $macros = [];
...
\t</div>
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous êtes connecté en tant {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Déconnexion</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\wamp64\\www\\elles\\templates\\security\\login.html.twig");
    }
}
